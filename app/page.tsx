...
const PRODUCTS: Product[] = [
  ...
  // --- GARAGE LAB & DETAILING ---
  {
    ...
    badge: "Organizer",
    price: 450,
    description: "Bagajınızda dağınıklığa son.",
  ...
  {
    id: "p9",
    name: "Mikrofiber Bez, Lastik Partlatıcı + Fırçası  , Demir Tozu",
    category: "garage",
    badge: "3'lü Modül",
    price: 699.90,
    description: "Aracınızda Su Bırakmayacak Bir Bez ile Her Şeyin Ötesinde",
    ...
    materials: ["Güçlendirilmiş Bez ila (Kimyasal Direnç)"],
  },
  {
    id: "p10",
